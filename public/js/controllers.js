...
GameCtrl = (function() {
  ...
  function GameCtrl($scope, $http, Game, Pad, Ball, HitDetector) {
    ...
    this.redraw = function() {
      return GameCtrl.prototype.redraw.apply(_this, arguments);
    };
    this.updatePads = function() {
      return GameCtrl.prototype.updatePads.apply(_this, arguments);
    };
    this.updateBall = function() {
      return GameCtrl.prototype.updateBall.apply(_this, arguments);
    };
    this.score = function(i) {
      return GameCtrl.prototype.score.apply(_this, arguments);
    };
    this.updateScore = function() {
      return GameCtrl.prototype.updateScore.apply(_this, arguments);
    };
    this.update = function() {
      return GameCtrl.prototype.update.apply(_this, arguments);
    };
    this.stop = function(key) {
      return GameCtrl.prototype.stop.apply(_this, arguments);
    };
    this.move = function(key) {
      return GameCtrl.prototype.move.apply(_this, arguments);
    };
