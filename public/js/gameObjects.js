...
Pad = (function(_super) {
  ...
  function Pad(id, xpos, ypos, padWidth, padHeight, upKey, downKey) {
    var _this = this;
    this.endMove = function(direction) {
      return Pad.prototype.endMove.apply(_this, arguments);
    };
    this.startMove = function(direction) {
      return Pad.prototype.startMove.apply(_this, arguments);
    };
    this.releaseKey = function(key) {
      return Pad.prototype.releaseKey.apply(_this, arguments);
    };
    this.pressKey = function(key) {
      return Pad.prototype.pressKey.apply(_this, arguments);
    };
    this.keyResponse = function(key, func) {
      return Pad.prototype.keyResponse.apply(_this, arguments);
    };
